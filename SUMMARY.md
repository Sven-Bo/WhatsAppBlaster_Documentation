...
* [Resolving Run-Time Error '-2146232576 (80131700)': Automation Error](troubleshooting/automation-error.md)
...
* [Is there a risk of getting banned on WhatsApp when using WhatsApp Blaster?](faq/is-there-a-risk-of-getting-banned-on-whatsapp-when-using-whatsapp-blaster.md)
* [What should I do If macros are disabled or blocked in the workbook?](faq/what-should-i-do-if-macros-are-disabled-or-blocked-in-the-workbook.md)
* [Why does the Excel template differ from the one shown in the YouTube video?](faq/why-does-the-excel-template-differ-from-the-one-shown-in-the-youtube-video.md)
* [What are the licensing terms for WhatsApp Blaster PRO?](faq/what-are-the-licensing-terms-for-whatsapp-blaster-pro.md)
* [Can I view or modify the VBA code?](faq/can-i-view-or-modify-the-vba-code.md)
* [Is there a maximum number of messages I can send per day?](faq/maximum-number-of-messages.md)
* [Which versions of Excel are supported?](faq/which-versions-of-excel-are-supported.md)
* [Can I use WhatsApp Blaster with WhatsApp Desktop?](faq/can-i-use-whatsapp-blaster-with-whatsapp-desktop.md)
